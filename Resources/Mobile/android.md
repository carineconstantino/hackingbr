...
```
## Smali/Baksmali
Link: https://github.com/JesusFreke/smali<br>
...
```
### smali to dex (gerar os arquivo classes.dex
```
java -jar smali.jar a [nome-da-pasta] -o classes.dex
```
...
## Bypass Biometria
Scripts Frida:<br> 
[+] [Fingerprint-bypass](https://github.com/WithSecureLabs/android-keystore-audit/blob/master/frida-scripts/fingerprint-bypass.js)<br>
